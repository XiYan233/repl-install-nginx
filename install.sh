...
#下载解压pcre
wget https://ftp.pcre.org/pub/pcre/pcre-8.43.tar.gz && tar zxvf pcre-8.43.tar.gz
#下载解压zlib
wget http://zlib.net/zlib-1.2.11.tar.gz && tar zxvf zlib-1.2.11.tar.gz
#下载解压openssl
wget https://www.openssl.org/source/openssl-1.0.2s.tar.gz && tar zxvf openssl-1.0.2s.tar.gz
#下载解压nginx
wget http://nginx.org/download/nginx-1.16.1.tar.gz && tar zxvf nginx-1.16.1.tar.gz
echo -e "\033[32m 完成 \033[0m" && echo -e "\033[32m 正在清理压缩包 \033[0m"
#删除压缩包
...
make
clear
echo -e "\033[32m 完成 \033[0m" && echo -e "\033[32m 休息3秒 \033[0m"
sleep 3s
